# [DEPRECATED] uni-app-types

**该依赖已废弃，请迁移到功能一致的 [@uni-helper/uni-app-types](https://www.npmjs.com/package/@uni-helper/uni-app-types)。**
...
`uni-app` 组件类型。[uni-cloud-types](https://github.com/ModyQyW/uni-helper/tree/main/packages/uni-cloud-types) 提供 `uni-cloud` 组件类型，[uni-ui-types](https://github.com/ModyQyW/uni-helper/tree/main/packages/uni-ui-types) 提供 `uni-ui` 组件类型。
