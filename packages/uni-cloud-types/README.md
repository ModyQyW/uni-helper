...
`uni-cloud` 组件类型。[uni-app-types](https://github.com/ModyQyW/uni-helper/tree/main/packages/uni-app-types) 提供 `uni-app` 组件类型，[uni-ui-types](https://github.com/ModyQyW/uni-helper/tree/main/packages/uni-ui-types) 提供 `uni-ui` 组件类型。
